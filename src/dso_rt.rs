...
//! Runtime glue for the shared-libc DSO (`libc.so.1`, C19 §8).
//!
...
//! no ordinary kernel Rust/C symbol is referenced (C19 §8.1).
//!
...
/// this is only the terminal landing pad; Phase 1 does not unwind or report
